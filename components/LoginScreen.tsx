    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-900 bg-opacity-70 p-4">
            <div className="w-full max-w-md bg-gray-800 bg-opacity-80 rounded-lg shadow-2xl p-8 border-2 border-cyan-500">
                ...
                <button onClick={handleGoogleLogin} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-md border-2 border-blue-800 shadow-lg transition duration-200 flex items-center justify-center transform hover:-translate-y-1 hover:brightness-110">
