    ...
    return (
        <Modal title="About & Privacy Policy" onClose={onClose}>
            <div className="text-gray-300 text-sm max-h-[60vh] overflow-y-auto pr-2 space-y-4">
                <h3 className="text-lg text-orange-300">About Battle Royale: Survival Grounds</h3>
                <p>
                    Battle Royale: Survival Grounds is a casual action game developed by SM Studio Inc. We are dedicated to providing a fun and engaging experience for our players.
                </p>

                <h3 className="text-lg text-orange-300">Privacy Policy</h3>
                ...
                <h4 className="text-md text-orange-400">Information Collection and Use</h4>
                <p>
                ...
                <ul className="list-disc list-inside space-y-1 pl-2">
                    ...
                    <li><strong>Game Data:</strong> We track your in-game progress, including gold, diamonds, characters, and other game-related statistics. This data is stored on secure servers (Firebase Realtime Database) to allow you to play across multiple devices and to maintain leaderboards.</li>
                </ul>
                
                <h4 className="text-md text-orange-400">Third-Party Services</h4>
                <p>
                ...
                <h4 className="text-md text-orange-400">Advertising</h4>
                <p>
                ...
                <h4 className="text-md text-orange-400">Data Security</h4>
                <p>
                ...
                <h4 className="text-md text-orange-400">Children's Privacy</h4>
                <p>
                    Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from children under 13.
                </p>

                <h4 className="text-md text-orange-400">Changes to This Privacy Policy</h4>
                <p>
                    We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.
                </p>
                
                <h4 className="text-md text-orange-400">Contact Us</h4>
                <p>
